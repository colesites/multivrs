...
export const mockLogs = [
  {
    id: "log_1",
    level: "INFO",
    message: "Deployment started for multivrs-x2",
  ...
  },
  {
    id: "log_2",
    level: "INFO",
    message: "Cloning repository multivrs/space@main",
  ...
  },
  {
    id: "log_3",
    level: "WARN",
    message: "Dependency resolution took longer than expected (14s)",
  ...
  },
  {
    id: "log_5",
    level: "ERROR",
    message: "Failed to resolve module 'lucide-react/Github'",
  ...
  },
  {
    id: "log_6",
    level: "INFO",
    message: "Retrying build with cache bypass...",
  ...
  },
  {
    id: "log_8",
    level: "INFO",
    message: "Starting deployment to Edge Network",
    timestamp: "10:25:54 AM",
    service: "edge-deployer",
  },
];
...
export const mockEmails = [
  {
    id: "em_1",
    address: "contact@kontinue.ai",
    forwardTo: "ryan@multivrs.space",
    status: "Active",
    caught: 1420,
  },
  {
    id: "em_2",
    address: "support@kontinue.ai",
    forwardTo: "zendesk-routing@multivrs.space",
    status: "Active",
    caught: 843,
  },
  {
    id: "em_3",
    address: "sales@echolive.io",
    forwardTo: "ryan@multivrs.space",
    status: "Pending MX",
    caught: 0,
  },
