...
export function DeploymentMonitor() {
  return (
    <div
      ...
      style={
        { "--glow-color": "rgba(59, 130, 246, 0.12)" } as React.CSSProperties
      }
    >
      {/* Ambient orbs */}
      <div className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-blue-500/4 blur-[80px] ambient-orb pointer-events-none" />
      <div
        className="absolute -bottom-16 -left-16 w-48 h-48 rounded-full bg-purple-500/3 blur-[60px] ambient-orb pointer-events-none"
      ...
      <div className="relative z-10 p-7 sm:p-9">
        ...
        <div className="flex items-center gap-2 text-[10px] text-muted-foreground/60 font-bold uppercase tracking-[0.2em] mb-6">
          ...
          <span className="ml-auto text-muted-foreground/40 normal-case tracking-normal font-medium">
            Updated 2 min ago
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-2 sm:ml-auto">
            ...
            <Button
              variant="outline"
              size="sm"
              className="px-4 text-[11px] font-bold gap-2"
            >
        ...
        <div className="flex flex-wrap items-end gap-6 pb-8 border-b border-white/4">
          <div>
            <p className="text-[10px] font-bold text-muted-foreground/50 uppercase tracking-[0.2em] mb-2">
              Active Memory
            </p>
          ...
          <div className="flex gap-3 mb-2">
            <Button
              size="lg"
              className="rounded-xl bg-purple-500/10 text-purple-300 border border-purple-500/20 px-5 text-xs font-bold hover:bg-purple-500/20"
            >
              Vertical Scale
            </Button>
            <Button
