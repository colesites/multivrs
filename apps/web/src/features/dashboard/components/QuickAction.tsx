...
export function QuickAction({ icon: Icon, label, href }: QuickActionProps) {
  return (
    <Link
      href={href}
      className="group flex items-center gap-3 rounded-xl border border-white/5 bg-white/2 p-3 transition-colors duration-300 hover:border-white/10 hover:bg-white/6"
    >
