        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 space-y-2">
              <div className="h-4 w-2/5 rounded-sm bg-white/[0.08]" />
              <div className="h-3 w-3/5 rounded-sm bg-white/[0.045]" />
            </div>
          </div>
          <div className="mt-5 h-6 w-28 rounded-md bg-white/[0.05]" />
          <div className="mt-5 h-3.5 w-3/4 rounded-sm bg-white/[0.07]" />
          <div className="mt-2 h-3 w-2/5 rounded-sm bg-white/[0.04]" />
