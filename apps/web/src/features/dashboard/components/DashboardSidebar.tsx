import { Activity, Bell, Cpu, Globe, ArrowUpRight, Zap, Database } from "lucide-react";
    ...
    <div className="flex flex-col gap-6 pt-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="rounded-[16px] border border-[var(--hairline)] bg-[var(--ink-raised)]/40 p-4 card-grain">
          <div className="flex items-center justify-between mb-4">
            <span className="text-[12px] font-medium text-muted-foreground">Last 30 days</span>
            <Button variant="outline" size="sm" className="h-6 text-[10px] px-2 font-bold rounded-md bg-white text-black hover:bg-white/90">
              Upgrade
            </Button>
          </div>
          ...
          <div className="mt-4 flex justify-center border-t border-[var(--hairline)] pt-3">
            <Button variant="ghost" size="sm" className="h-6 text-[11px] text-muted-foreground/80 hover:text-foreground">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="rounded-[16px] border border-[var(--hairline)] bg-[var(--ink-raised)]/40 p-6 flex flex-col items-center text-center card-grain">
          ...
          <h4 className="text-[13px] font-semibold text-foreground mb-1">Get alerted for anomalies</h4>
          ...
          <Button variant="outline" size="sm" className="h-8 text-[11px] rounded-lg bg-white/[0.02] border-[var(--hairline)] hover:bg-white/[0.05]">
            Upgrade to Pro
          </Button>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between px-1">
          <h3 className="text-[13px] font-semibold text-foreground">Recent Previews</h3>
        </div>
