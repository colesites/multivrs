...
export function ResourceCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "h-[2px] w-full bg-linear-to-r from-transparent to-transparent star-glow",
          accent.topLine,
        )}
      />
        ...
        <div className="flex items-start justify-between gap-4 mb-5">
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <h3
                className={cn(
                  "text-[15px] font-bold text-foreground tracking-tight truncate transition-colors duration-300",
                  accent.titleHover,
                )}
              >
                {title}
              ...
              {subtitle && (
                <p className="text-[11px] text-muted-foreground/50 font-medium mt-0.5 truncate font-mono">
                  {subtitle}
                </p>
              )}
            </div>
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            {status && (
              <div
                className={cn(
                  "flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[9px] font-bold uppercase tracking-[0.15em]",
                  STATUS_STYLES[status.variant].pill,
                )}
              >
                <div className="relative flex h-1.5 w-1.5">
                  ...
                  <span
                    className={cn(
                      ...
                      STATUS_STYLES[status.variant].dot,
                    )}
                  />
                </div>
                {status.label}
