...
const COLOR_MAP = {
  emerald:
    "from-emerald-500/[0.06] to-emerald-500/[0.02] border-emerald-500/[0.08]",
  ...
  purple:
    "from-purple-500/[0.06] to-purple-500/[0.02] border-purple-500/[0.08]",
} as const;
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full relative z-10">
        ...
        <span className="bg-white/4 rounded-md px-1.5 py-0.5 text-[9px] text-muted-foreground/40 font-bold">
          {badge}
        </span>
      </div>
